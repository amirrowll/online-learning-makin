...
const MenuTabs = () => {
    const [activeTab, setActiveTab] = useState('درباره دوره');
    const tabs = ['درباره دوره', 'درباره استاد', 'سر فصل ها',];
            ...
            <div className='bg-white mt-10 rounded-xl py-[23px] px-4 flex flex-wrap md:flex-nowrap gap-8 items-center justify-around'>
                {tabs.map((tab) => (
                    <p
                        ...
                        className={`text-xl h-full font-kalamehMedium cursor-pointer ${activeTab === tab
