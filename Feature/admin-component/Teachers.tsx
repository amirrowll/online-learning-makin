...
import TeacherModal from '@/Feature/admin-component/teachermodal/TeacherModal'; // Import the modal component
...
function Teachers() {
  ...
  const teachers = [
    { id: 1, row: "1", name: "حسین رفیعی", coursesCount: "۳", isActive: true, image: "/panel/ostadFront.svg" },
    { id: 2, row: "2", name: "علیرضا مومنی", coursesCount: "۱", isActive: false, image: "/panel/ostadBack.svg" },
  ...
  return (
    <div className='xl:px-20'>
      <div className='flex items-center justify-between mt-5 '>
        <input
          type="text"
          className='w-[420px] rounded-2xl border border-[#E0E0E0] px-4 py-2 text-gray-700 font-kalamehRegular text-base'
