        ...
        <div className=' flex h-screen flex-col items-center justify-center bg-[#F9F9F9] '>
            ...
            <div className='mt-6'>
                <form noValidate onSubmit={handleSubmit(onSubmit, onErrorHandler)}>
                    ...
                    <div className='flex items-center font-kalamehBold text-[16px] text-[#36A8D9] justify-center gap-3 mt-5'>
                        <Link href='auth/register'><button> عضویت در مکین </button></Link>
                        <Link href='auth/login'><button> ورود در مکین </button></Link>
                    </div>
